...
import runTypeCheck from '../../src/modules/llm/annotator/runTypeCheck';
...
describe('runTypeCheck', () => {
    it('should process be finished', async () => {
        ...
        const result = await runTypeCheck(model as any, "The sales of BYD have been steadily increasing over the past 5 years", "trend");
